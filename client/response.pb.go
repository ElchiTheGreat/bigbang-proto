...
var file_client_response_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x5c, 0x0a, 0x10, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x55, 0x6e, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x66, 0x69,
...
var file_client_response_proto_goTypes = []any{
	...
	(*Logs)(nil),                    // 4: client.Logs
	(*ResponseEnvoyAdmin)(nil),      // 5: client.ResponseEnvoyAdmin
	(*ResponseUnDeploy)(nil),        // 6: client.ResponseUnDeploy
...
var file_client_response_proto_depIdxs = []int32{
	...
	4, // 1: client.ResponseService.logs:type_name -> client.Logs
