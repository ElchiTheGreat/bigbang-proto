...
type ResponseBgp struct {
	...
	Config          *BgpConfig          `protobuf:"bytes,1,opt,name=config,proto3" json:"config,omitempty"`
	State           *BgpState           `protobuf:"bytes,2,opt,name=state,proto3" json:"state,omitempty"`
	Neighbors       []*BgpNeighborState `protobuf:"bytes,3,rep,name=neighbors,proto3" json:"neighbors,omitempty"`
	Routes          []*BgpRoute         `protobuf:"bytes,4,rep,name=routes,proto3" json:"routes,omitempty"`
	Statistics      *BgpStatistics      `protobuf:"bytes,5,opt,name=statistics,proto3" json:"statistics,omitempty"`
	OperationResult string              `protobuf:"bytes,6,opt,name=operation_result,json=operationResult,proto3" json:"operation_result,omitempty"`
}
...
func (x *ResponseBgp) GetNeighbors() []*BgpNeighborState {
	if x != nil {
		return x.Neighbors
	}
	return nil
...
func (x *ResponseBgp) GetRoutes() []*BgpRoute {
	if x != nil {
		return x.Routes
	}
	return nil
...
func (x *ResponseBgp) GetOperationResult() string {
	if x != nil {
...
var file_client_response_proto_rawDesc = []byte{
	...
	0x74, 0x2f, 0x62, 0x67, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9d, 0x01, 0x0a, 0x0e,
	...
	0x52, 0x0a, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x66, 0x61, 0x63, 0x65, 0x73, 0x22, 0xa4, 0x02, 0x0a,
	0x0b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x67, 0x70, 0x12, 0x29, 0x0a, 0x06,
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x63,
	0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x42, 0x67, 0x70, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52,
	0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x26, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65,
	...
	,
...
var file_client_response_proto_goTypes = []any{
	...
	(*ResponseBgp)(nil),             // 11: client.ResponseBgp
	...
	(*BgpConfig)(nil),               // 20: client.BgpConfig
	(*BgpState)(nil),                // 21: client.BgpState
	(*BgpNeighborState)(nil),        // 22: client.BgpNeighborState
	(*BgpRoute)(nil),                // 23: client.BgpRoute
	(*BgpStatistics)(nil),           // 24: client.BgpStatistics
}
var file_client_response_proto_depIdxs = []int32{
	...
	20, // 11: client.ResponseBgp.config:type_name -> client.BgpConfig
	21, // 12: client.ResponseBgp.state:type_name -> client.BgpState
	22, // 13: client.ResponseBgp.neighbors:type_name -> client.BgpNeighborState
	23, // 14: client.ResponseBgp.routes:type_name -> client.BgpRoute
	24, // 15: client.ResponseBgp.statistics:type_name -> client.BgpStatistics
