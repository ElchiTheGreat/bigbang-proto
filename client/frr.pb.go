...
type BgpRouteMapSet struct {
	...
	SetLocalPreference string `protobuf:"bytes,1,opt,name=set_local_preference,json=setLocalPreference,proto3" json:"set_local_preference,omitempty"`
...
func (x *BgpRouteMapSet) GetSetLocalPreference() string {
	if x != nil {
...
var file_client_frr_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x12, 0x73, 0x65, 0x74, 0x4c, 0x6f, 0x63, 0x61, 0x6c, 0x50, 0x72, 0x65,
	...
	0x50, 0x54, 0x49, 0x4d, 0x49, 0x5a, 0x45, 0x5f, 0x43, 0x41, 0x43, 0x48, 0x45, 0x10, 0x1b, 0x12,
