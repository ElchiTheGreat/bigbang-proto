...
const (
	...
	// ============================================================================
	// BGP TRANSACTION OPERATIONS (TransactionManager Functions)
	// ============================================================================
	BgpOperationType_BGP_BEGIN_TRANSACTION         BgpOperationType = 48 // BeginTransaction()
	BgpOperationType_BGP_COMMIT_TRANSACTION        BgpOperationType = 49 // CommitTransaction()
	BgpOperationType_BGP_ROLLBACK_TRANSACTION      BgpOperationType = 50 // RollbackTransaction()
	BgpOperationType_BGP_ADD_TRANSACTION_OPERATION BgpOperationType = 51 // AddOperation()
	BgpOperationType_BGP_EXECUTE_TRANSACTION       BgpOperationType = 52 // ExecuteTransaction()
	BgpOperationType_BGP_GET_TRANSACTION_STATUS    BgpOperationType = 53 // GetTransactionStatus()
	// ============================================================================
	...
	// ============================================================================
	// BGP CACHE & PERFORMANCE OPERATIONS (Manager Functions)
	// ============================================================================
	BgpOperationType_BGP_GET_CACHE_STATS            BgpOperationType = 59 // GetBgpCacheStats()
	BgpOperationType_BGP_GET_CACHE_HIT_RATIO        BgpOperationType = 60 // GetCacheHitRatio()
	BgpOperationType_BGP_PERIODIC_CACHE_CLEANUP     BgpOperationType = 61 // PeriodicCacheCleanup()
	BgpOperationType_BGP_HANDLE_CACHE_STATS         BgpOperationType = 62 // HandleCacheStats()
	BgpOperationType_BGP_HANDLE_CACHE_CLEAR         BgpOperationType = 63 // HandleCacheClear()
	BgpOperationType_BGP_HANDLE_PERFORMANCE_METRICS BgpOperationType = 64 // HandlePerformanceMetrics()
	// ============================================================================
...
var (
	BgpOperationType_name = map[int32]string{
		...
		48: "BGP_BEGIN_TRANSACTION",
		49: "BGP_COMMIT_TRANSACTION",
		50: "BGP_ROLLBACK_TRANSACTION",
		51: "BGP_ADD_TRANSACTION_OPERATION",
		52: "BGP_EXECUTE_TRANSACTION",
		53: "BGP_GET_TRANSACTION_STATUS",
		...
		59: "BGP_GET_CACHE_STATS",
		60: "BGP_GET_CACHE_HIT_RATIO",
		61: "BGP_PERIODIC_CACHE_CLEANUP",
		62: "BGP_HANDLE_CACHE_STATS",
		63: "BGP_HANDLE_CACHE_CLEAR",
		64: "BGP_HANDLE_PERFORMANCE_METRICS",
	...
	BgpOperationType_value = map[string]int32{
		...
		"BGP_BEGIN_TRANSACTION":               48,
		"BGP_COMMIT_TRANSACTION":              49,
		"BGP_ROLLBACK_TRANSACTION":            50,
		"BGP_ADD_TRANSACTION_OPERATION":       51,
		"BGP_EXECUTE_TRANSACTION":             52,
		"BGP_GET_TRANSACTION_STATUS":          53,
		...
		"BGP_GET_CACHE_STATS":                 59,
		"BGP_GET_CACHE_HIT_RATIO":             60,
		"BGP_PERIODIC_CACHE_CLEANUP":          61,
		"BGP_HANDLE_CACHE_STATS":              62,
		"BGP_HANDLE_CACHE_CLEAR":              63,
		"BGP_HANDLE_PERFORMANCE_METRICS":      64,
...
type BgpConfig struct {
	...
	AdministrativeDistance uint32              `protobuf:"varint,13,opt,name=administrative_distance,json=administrativeDistance,proto3" json:"administrative_distance,omitempty"`
...
// BGP Network Configuration (IPv4 only)
...
type BgpTransactionOperation struct {
	...
	Network       *BgpNetwork       `protobuf:"bytes,4,opt,name=network,proto3" json:"network,omitempty"`                                  // Network for the operation
...
func (x *BgpTransactionOperation) GetNetwork() *BgpNetwork {
	if x != nil {
		return x.Network
	}
	return nil
...
type BgpValidationRequest struct {
	...
	Network          *BgpNetwork       `protobuf:"bytes,4,opt,name=network,proto3" json:"network,omitempty"`                                            // Network to validate
...
func (x *BgpValidationRequest) GetNetwork() *BgpNetwork {
	if x != nil {
		return x.Network
	}
	return nil
...
type BgpNetworkUpdate struct {
	...
	NewNetwork     *BgpNetwork `protobuf:"bytes,2,opt,name=new_network,json=newNetwork,proto3" json:"new_network,omitempty"`             // New network configuration
...
func (x *BgpNetworkUpdate) GetNewNetwork() *BgpNetwork {
	if x != nil {
		return x.NewNetwork
	}
	return nil
...
func (x *BgpPolicyConfig) Reset() {
	*x = BgpPolicyConfig{}
	mi := &file_client_frr_proto_msgTypes[69]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BgpPolicyConfig) Descriptor() ([]byte, []int) {
	return file_client_frr_proto_rawDescGZIP(), []int{69}
}
...
var file_client_frr_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x06, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x22, 0x80, 0x06, 0x0a, 0x09, 0x42,
	...
	0x63, 0x65, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x16, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x69,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x09, 0x52, 0x07, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x12, 0x1c, 0x0a, 0x09, 0x69, 0x6e,
	0x74, 0x65, 0x72, 0x66, 0x61, 0x63, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x69,
	0x6e, 0x74, 0x65, 0x72, 0x66, 0x61, 0x63, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x6d, 0x65, 0x74, 0x72,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x12, 0x37, 0x0a, 0x17, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x69, 0x73, 0x74, 0x72, 0x61, 0x74, 0x69,
	0x76, 0x65, 0x5f, 0x64, 0x69, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x16, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x69, 0x73, 0x74, 0x72, 0x61, 0x74, 0x69, 0x76,
	0x65, 0x44, 0x69, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x63, 0x74,
	0x69, 0x76, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x61, 0x63, 0x74, 0x69, 0x76,
	0x65, 0x12, 0x10, 0x0a, 0x03, 0x66, 0x69, 0x62, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x52, 0x03,
	0x66, 0x69, 0x62, 0x22, 0x87, 0x03, 0x0a, 0x10, 0x53, 0x74, 0x61, 0x74, 0x69, 0x63, 0x53, 0x74,
	...
	0x70, 0x76, 0x34, 0x5f, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d,
	0x52, 0x0a, 0x69, 0x70, 0x76, 0x34, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x73, 0x12, 0x23, 0x0a, 0x0d,
	0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x5f, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x73, 0x18, 0x03, 0x20,
	...
	,
	...
	,
	...
	0x78, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b,
	0x50, 0x72, 0x65, 0x66, 0x69, 0x78, 0x12, 0x30, 0x0a, 0x09, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x5f,
	0x6d, 0x61, 0x70, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x63, 0x6c, 0x69, 0x65,
	...
	0x75, 0x6e, 0x69, 0x74, 0x79, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b,
	...
	0x66, 0x69, 0x78, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15,
	0x2e, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x42, 0x67, 0x70, 0x50, 0x72, 0x65, 0x66, 0x69,
	0x78, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x0a, 0x70, 0x72, 0x65, 0x66, 0x69, 0x78, 0x4c, 0x69, 0x73,
	0x74, 0x12, 0x1c, 0x0a, 0x09, 0x63, 0x6f, 0x6d, 0x6d, 0x75, 0x6e, 0x69, 0x74, 0x79, 0x18, 0x0a,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x63, 0x6f, 0x6d, 0x6d, 0x75, 0x6e, 0x69, 0x74, 0x79, 0x12,
	0x1b, 0x0a, 0x09, 0x61, 0x73, 0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x0b, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x08, 0x61, 0x73, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x25, 0x0a, 0x0e,
	...
	0x6e, 0x49, 0x64, 0x12, 0x54, 0x0a, 0x15, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x5f, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x0d, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x42, 0x67, 0x70, 0x54,
	...
	,
	...
	,
	...
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x4e, 0x0a, 0x13, 0x70, 0x65, 0x72, 0x66, 0x6f, 0x72,
	0x6d, 0x61, 0x6e, 0x63, 0x65, 0x5f, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x18, 0x14, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x42, 0x67, 0x70,
	...
	0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x12, 0x51, 0x0a, 0x14, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x18, 0x15,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x52, 0x13, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f,
	...
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x17, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x63,
	0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x42, 0x67, 0x70, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63,
	...
	0x13, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x72, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x18, 0x18, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x63, 0x6c, 0x69,
	0x65, 0x6e, 0x74, 0x2e, 0x42, 0x67, 0x70, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x12, 0x76, 0x61, 0x6c, 0x69, 0x64,
	...
	,
	...
	0x79, 0x70, 0x65, 0x52, 0x09, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x18,
	0x0a, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x12, 0x2c, 0x0a, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x04, 0x20, 0x01,
	...
	,
	...
	,
	...
	0x72, 0x69, 0x63, 0x73, 0x12, 0x3c, 0x0a, 0x0d, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x5f, 0x73,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x63, 0x6c,
	0x69, 0x65, 0x6e, 0x74, 0x2e, 0x42, 0x67, 0x70, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x53, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x52, 0x0c, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x53, 0x74, 0x61, 0x74,
	...
	,
	...
	0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x72,
	0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x70, 0x65, 0x65, 0x72,
	...
	,
	...
	,
	...
	,
	...
	0x01, 0x0a, 0x16, 0x42, 0x67, 0x70, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x25, 0x0a, 0x0e, 0x74, 0x72, 0x61,
	...
	,
	...
	,
	...
	0x6e, 0x54, 0x79, 0x70, 0x65, 0x12, 0x32, 0x0a, 0x06, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x18,
	0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x42,
	0x67, 0x70, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x72, 0x72, 0x6f,
	0x72, 0x52, 0x06, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x12, 0x38, 0x0a, 0x08, 0x77, 0x61, 0x72,
	0x6e, 0x69, 0x6e, 0x67, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x63, 0x6c,
	...
	0x6e, 0x67, 0x73, 0x12, 0x63, 0x0a, 0x12, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x5f, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x34, 0x2e, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x42, 0x67, 0x70, 0x56, 0x61, 0x6c, 0x69,
	...
	,
	...
	0x42, 0x67, 0x70, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x72, 0x72,
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x5f,
	...
	,
	...
	,
	...
	,
	...
	0x5f, 0x44, 0x45, 0x4e, 0x59, 0x10, 0x02, 0x2a, 0x86, 0x02, 0x0a, 0x13, 0x53, 0x74, 0x61, 0x74,
	...
	,
	...
	0x49, 0x54, 0x54, 0x45, 0x44, 0x10, 0x03, 0x12, 0x1b, 0x0a, 0x17, 0x54, 0x52, 0x41, 0x4e, 0x53,
	0x41, 0x43, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x52, 0x4f, 0x4c, 0x4c, 0x45, 0x44, 0x5f, 0x42, 0x41,
	0x43, 0x4b, 0x10, 0x04, 0x12, 0x16, 0x0a, 0x12, 0x54, 0x52, 0x41, 0x4e, 0x53, 0x41, 0x43, 0x54,
	0x49, 0x4f, 0x4e, 0x5f, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x05, 0x42, 0x2d, 0x5a, 0x2b,
...
var file_client_frr_proto_msgTypes = make([]protoimpl.MessageInfo, 86)
var file_client_frr_proto_goTypes = []any{
	...
	(*BgpNetwork)(nil),                   // 12: client.BgpNetwork
	(*BgpRouteMap)(nil),                  // 13: client.BgpRouteMap
	(*BgpRouteMapMatch)(nil),             // 14: client.BgpRouteMapMatch
	(*BgpRouteMapSet)(nil),               // 15: client.BgpRouteMapSet
	(*BgpCommunityList)(nil),             // 16: client.BgpCommunityList
	(*BgpPrefixList)(nil),                // 17: client.BgpPrefixList
	(*ShowBgpSummary)(nil),               // 18: client.ShowBgpSummary
	(*BgpSummaryInstance)(nil),           // 19: client.BgpSummaryInstance
	(*BgpPeerSummaryInfo)(nil),           // 20: client.BgpPeerSummaryInfo
	(*ShowBgpNeighbors)(nil),             // 21: client.ShowBgpNeighbors
	(*BgpNeighborInfo)(nil),              // 22: client.BgpNeighborInfo
	(*BgpGracefulRestartInfo)(nil),       // 23: client.BgpGracefulRestartInfo
	(*BgpGracefulRestartTimers)(nil),     // 24: client.BgpGracefulRestartTimers
	(*BgpMessageStats)(nil),              // 25: client.BgpMessageStats
	(*BgpPrefixStats)(nil),               // 26: client.BgpPrefixStats
	(*BgpAddressFamilyInfo)(nil),         // 27: client.BgpAddressFamilyInfo
	(*BgpIpv4UnicastInfo)(nil),           // 28: client.BgpIpv4UnicastInfo
	(*ShowBgpRoutes)(nil),                // 29: client.ShowBgpRoutes
	(*BgpRouteInfo)(nil),                 // 30: client.BgpRouteInfo
	(*BgpPath)(nil),                      // 31: client.BgpPath
	(*BgpState)(nil),                     // 32: client.BgpState
	(*BgpNeighborState)(nil),             // 33: client.BgpNeighborState
	(*BgpStatistics)(nil),                // 34: client.BgpStatistics
	(*BgpGlobalStatistics)(nil),          // 35: client.BgpGlobalStatistics
	(*BgpTableStatistics)(nil),           // 36: client.BgpTableStatistics
	(*BgpMessageStatistics)(nil),         // 37: client.BgpMessageStatistics
	(*BgpNeighborStatistics)(nil),        // 38: client.BgpNeighborStatistics
	(*StaticConfig)(nil),                 // 39: client.StaticConfig
	(*StaticGlobalConfig)(nil),           // 40: client.StaticGlobalConfig
	(*StaticRoute)(nil),                  // 41: client.StaticRoute
	(*StaticRouteFlags)(nil),             // 42: client.StaticRouteFlags
	(*StaticRouteTable)(nil),             // 43: client.StaticRouteTable
	(*StaticNexthopGroup)(nil),           // 44: client.StaticNexthopGroup
	(*StaticNexthop)(nil),                // 45: client.StaticNexthop
	(*ShowStaticRoutes)(nil),             // 46: client.ShowStaticRoutes
	(*StaticRouteEntry)(nil),             // 47: client.StaticRouteEntry
	(*StaticRouteNexthop)(nil),           // 48: client.StaticRouteNexthop
	(*StaticStatistics)(nil),             // 49: client.StaticStatistics
	(*StaticTableStatistics)(nil),        // 50: client.StaticTableStatistics
	(*StaticRouteTypeStatistics)(nil),    // 51: client.StaticRouteTypeStatistics
	(*StaticNexthopGroupStatistics)(nil), // 52: client.StaticNexthopGroupStatistics
	(*RequestBgp)(nil),                   // 53: client.RequestBgp
	(*ResponseBgp)(nil),                  // 54: client.ResponseBgp
	(*RequestStatic)(nil),                // 55: client.RequestStatic
	(*ResponseStatic)(nil),               // 56: client.ResponseStatic
	(*BgpStatus)(nil),                    // 57: client.BgpStatus
	(*BgpPerformanceMetrics)(nil),        // 58: client.BgpPerformanceMetrics
	(*BgpHealthStatus)(nil),              // 59: client.BgpHealthStatus
	(*BgpCacheInfo)(nil),                 // 60: client.BgpCacheInfo
	(*BgpSummary)(nil),                   // 61: client.BgpSummary
	(*BgpPeerSummary)(nil),               // 62: client.BgpPeerSummary
	(*BgpTransactionOperation)(nil),      // 63: client.BgpTransactionOperation
	(*BgpTransactionResponse)(nil),       // 64: client.BgpTransactionResponse
	(*BgpValidationRequest)(nil),         // 65: client.BgpValidationRequest
	(*BgpValidationResponse)(nil),        // 66: client.BgpValidationResponse
	(*BgpValidationError)(nil),           // 67: client.BgpValidationError
	(*BgpValidationWarning)(nil),         // 68: client.BgpValidationWarning
	(*BgpProtocolStatus)(nil),            // 69: client.BgpProtocolStatus
	(*BgpRedistributionStatus)(nil),      // 70: client.BgpRedistributionStatus
	(*BgpRedistributionMetrics)(nil),     // 71: client.BgpRedistributionMetrics
	(*BgpNetworkUpdate)(nil),             // 72: client.BgpNetworkUpdate
	(*BgpConfigConsistency)(nil),         // 73: client.BgpConfigConsistency
	(*BgpNeighborCompatibility)(nil),     // 74: client.BgpNeighborCompatibility
	(*BgpASNumbersValidation)(nil),       // 75: client.BgpASNumbersValidation
	(*BgpPolicyConfig)(nil),              // 76: client.BgpPolicyConfig
	nil,                                  // 77: client.ShowBgpSummary.InstancesEntry
	nil,                                  // 78: client.BgpSummaryInstance.PeersEntry
	nil,                                  // 79: client.ShowBgpNeighbors.NeighborsEntry
	nil,                                  // 80: client.BgpGracefulRestartInfo.EndOfRibSendEntry
	nil,                                  // 81: client.BgpGracefulRestartInfo.EndOfRibRecvEntry
	nil,                                  // 82: client.ShowBgpRoutes.RoutesEntry
	nil,                                  // 83: client.ShowStaticRoutes.RoutesEntry
	nil,                                  // 84: client.ResponseBgp.CacheStatisticsEntry
	nil,                                  // 85: client.ResponseBgp.CacheHitRatiosEntry
	nil,                                  // 86: client.BgpStatus.CacheStatisticsEntry
	nil,                                  // 87: client.BgpStatus.NetworkMetricsEntry
	nil,                                  // 88: client.BgpPerformanceMetrics.CacheHitRatiosEntry
	nil,                                  // 89: client.BgpValidationResponse.ValidationDetailsEntry
	nil,                                  // 90: client.BgpProtocolStatus.DaemonStatisticsEntry
	nil,                                  // 91: client.BgpRedistributionStatus.RedistributionMetricsEntry
	nil,                                  // 92: client.BgpPolicyConfig.PolicyStatisticsEntry
}
var file_client_frr_proto_depIdxs = []int32{
	8,   // 0: client.BgpConfig.neighbors:type_name -> client.BgpNeighbor
	12,  // 1: client.BgpConfig.networks:type_name -> client.BgpNetwork
	13,  // 2: client.BgpConfig.route_maps:type_name -> client.BgpRouteMap
	16,  // 3: client.BgpConfig.community_lists:type_name -> client.BgpCommunityList
	17,  // 4: client.BgpConfig.prefix_lists:type_name -> client.BgpPrefixList
	9,   // 5: client.BgpNeighbor.timers:type_name -> client.BgpNeighborTimers
	10,  // 6: client.BgpNeighbor.route_maps:type_name -> client.BgpNeighborRouteMaps
	11,  // 7: client.BgpNeighbor.prefix_lists:type_name -> client.BgpNeighborPrefixLists
	2,   // 8: client.BgpRouteMap.action:type_name -> client.BgpRouteMapAction
	14,  // 9: client.BgpRouteMap.match_conditions:type_name -> client.BgpRouteMapMatch
	15,  // 10: client.BgpRouteMap.set_actions:type_name -> client.BgpRouteMapSet
	2,   // 11: client.BgpCommunityList.action:type_name -> client.BgpRouteMapAction
	2,   // 12: client.BgpPrefixList.action:type_name -> client.BgpRouteMapAction
	77,  // 13: client.ShowBgpSummary.instances:type_name -> client.ShowBgpSummary.InstancesEntry
	78,  // 14: client.BgpSummaryInstance.peers:type_name -> client.BgpSummaryInstance.PeersEntry
	79,  // 15: client.ShowBgpNeighbors.neighbors:type_name -> client.ShowBgpNeighbors.NeighborsEntry
	23,  // 16: client.BgpNeighborInfo.graceful_restart_info:type_name -> client.BgpGracefulRestartInfo
	25,  // 17: client.BgpNeighborInfo.message_stats:type_name -> client.BgpMessageStats
	26,  // 18: client.BgpNeighborInfo.prefix_stats:type_name -> client.BgpPrefixStats
	27,  // 19: client.BgpNeighborInfo.address_family_info:type_name -> client.BgpAddressFamilyInfo
	80,  // 20: client.BgpGracefulRestartInfo.end_of_rib_send:type_name -> client.BgpGracefulRestartInfo.EndOfRibSendEntry
	81,  // 21: client.BgpGracefulRestartInfo.end_of_rib_recv:type_name -> client.BgpGracefulRestartInfo.EndOfRibRecvEntry
	24,  // 22: client.BgpGracefulRestartInfo.timers:type_name -> client.BgpGracefulRestartTimers
	28,  // 23: client.BgpAddressFamilyInfo.ipv4_unicast:type_name -> client.BgpIpv4UnicastInfo
	82,  // 24: client.ShowBgpRoutes.routes:type_name -> client.ShowBgpRoutes.RoutesEntry
	31,  // 25: client.BgpRouteInfo.paths:type_name -> client.BgpPath
	33,  // 26: client.BgpState.neighbor_states:type_name -> client.BgpNeighborState
	35,  // 27: client.BgpStatistics.global_stats:type_name -> client.BgpGlobalStatistics
	36,  // 28: client.BgpStatistics.table_stats:type_name -> client.BgpTableStatistics
	37,  // 29: client.BgpStatistics.message_stats:type_name -> client.BgpMessageStatistics
	38,  // 30: client.BgpStatistics.neighbor_stats:type_name -> client.BgpNeighborStatistics
	41,  // 31: client.StaticConfig.routes:type_name -> client.StaticRoute
	43,  // 32: client.StaticConfig.route_tables:type_name -> client.StaticRouteTable
	44,  // 33: client.StaticConfig.nexthop_groups:type_name -> client.StaticNexthopGroup
	40,  // 34: client.StaticConfig.global_config:type_name -> client.StaticGlobalConfig
	4,   // 35: client.StaticRoute.route_type:type_name -> client.StaticRouteType
	42,  // 36: client.StaticRoute.flags:type_name -> client.StaticRouteFlags
	41,  // 37: client.StaticRouteTable.routes:type_name -> client.StaticRoute
	45,  // 38: client.StaticNexthopGroup.nexthops:type_name -> client.StaticNexthop
	5,   // 39: client.StaticNexthopGroup.type:type_name -> client.StaticNexthopGroupType
	83,  // 40: client.ShowStaticRoutes.routes:type_name -> client.ShowStaticRoutes.RoutesEntry
	48,  // 41: client.StaticRouteEntry.nexthops:type_name -> client.StaticRouteNexthop
	50,  // 42: client.StaticStatistics.table_stats:type_name -> client.StaticTableStatistics
	51,  // 43: client.StaticStatistics.route_type_stats:type_name -> client.StaticRouteTypeStatistics
	52,  // 44: client.StaticStatistics.nexthop_group_stats:type_name -> client.StaticNexthopGroupStatistics
	1,   // 45: client.RequestBgp.operation:type_name -> client.BgpOperationType
	7,   // 46: client.RequestBgp.config:type_name -> client.BgpConfig
	8,   // 47: client.RequestBgp.neighbor:type_name -> client.BgpNeighbor
	12,  // 48: client.RequestBgp.network:type_name -> client.BgpNetwork
	13,  // 49: client.RequestBgp.route_map:type_name -> client.BgpRouteMap
	16,  // 50: client.RequestBgp.community_list:type_name -> client.BgpCommunityList
	17,  // 51: client.RequestBgp.prefix_list:type_name -> client.BgpPrefixList
	63,  // 52: client.RequestBgp.transaction_operation:type_name -> client.BgpTransactionOperation
	65,  // 53: client.RequestBgp.validation_request:type_name -> client.BgpValidationRequest
	1,   // 54: client.ResponseBgp.operation:type_name -> client.BgpOperationType
	7,   // 55: client.ResponseBgp.config:type_name -> client.BgpConfig
	8,   // 56: client.ResponseBgp.neighbors:type_name -> client.BgpNeighbor
	12,  // 57: client.ResponseBgp.networks:type_name -> client.BgpNetwork
	32,  // 58: client.ResponseBgp.state:type_name -> client.BgpState
	34,  // 59: client.ResponseBgp.statistics:type_name -> client.BgpStatistics
	13,  // 60: client.ResponseBgp.route_maps:type_name -> client.BgpRouteMap
	16,  // 61: client.ResponseBgp.community_lists:type_name -> client.BgpCommunityList
	17,  // 62: client.ResponseBgp.prefix_lists:type_name -> client.BgpPrefixList
	18,  // 63: client.ResponseBgp.show_summary:type_name -> client.ShowBgpSummary
	21,  // 64: client.ResponseBgp.show_neighbors:type_name -> client.ShowBgpNeighbors
	29,  // 65: client.ResponseBgp.show_routes:type_name -> client.ShowBgpRoutes
	57,  // 66: client.ResponseBgp.status:type_name -> client.BgpStatus
	8,   // 67: client.ResponseBgp.neighbor:type_name -> client.BgpNeighbor
	38,  // 68: client.ResponseBgp.neighbor_statistics:type_name -> client.BgpNeighborStatistics
	59,  // 69: client.ResponseBgp.health_status:type_name -> client.BgpHealthStatus
	69,  // 70: client.ResponseBgp.protocol_status:type_name -> client.BgpProtocolStatus
	58,  // 71: client.ResponseBgp.performance_metrics:type_name -> client.BgpPerformanceMetrics
	64,  // 72: client.ResponseBgp.transaction_response:type_name -> client.BgpTransactionResponse
	6,   // 73: client.ResponseBgp.transaction_status:type_name -> client.BgpTransactionStatus
	66,  // 74: client.ResponseBgp.validation_response:type_name -> client.BgpValidationResponse
	84,  // 75: client.ResponseBgp.cache_statistics:type_name -> client.ResponseBgp.CacheStatisticsEntry
	85,  // 76: client.ResponseBgp.cache_hit_ratios:type_name -> client.ResponseBgp.CacheHitRatiosEntry
	70,  // 77: client.ResponseBgp.redistribution_status:type_name -> client.BgpRedistributionStatus
	3,   // 78: client.RequestStatic.operation:type_name -> client.StaticOperationType
	39,  // 79: client.RequestStatic.config:type_name -> client.StaticConfig
	41,  // 80: client.RequestStatic.route:type_name -> client.StaticRoute
	43,  // 81: client.RequestStatic.route_table:type_name -> client.StaticRouteTable
	44,  // 82: client.RequestStatic.nexthop_group:type_name -> client.StaticNexthopGroup
	3,   // 83: client.ResponseStatic.operation:type_name -> client.StaticOperationType
	39,  // 84: client.ResponseStatic.config:type_name -> client.StaticConfig
	41,  // 85: client.ResponseStatic.routes:type_name -> client.StaticRoute
	43,  // 86: client.ResponseStatic.route_tables:type_name -> client.StaticRouteTable
	44,  // 87: client.ResponseStatic.nexthop_groups:type_name -> client.StaticNexthopGroup
	49,  // 88: client.ResponseStatic.statistics:type_name -> client.StaticStatistics
	46,  // 89: client.ResponseStatic.show_routes:type_name -> client.ShowStaticRoutes
	86,  // 90: client.BgpStatus.cache_statistics:type_name -> client.BgpStatus.CacheStatisticsEntry
	87,  // 91: client.BgpStatus.network_metrics:type_name -> client.BgpStatus.NetworkMetricsEntry
	58,  // 92: client.BgpStatus.performance_metrics:type_name -> client.BgpPerformanceMetrics
	59,  // 93: client.BgpStatus.health_status:type_name -> client.BgpHealthStatus
	88,  // 94: client.BgpPerformanceMetrics.cache_hit_ratios:type_name -> client.BgpPerformanceMetrics.CacheHitRatiosEntry
	62,  // 95: client.BgpSummary.peer_summary:type_name -> client.BgpPeerSummary
	7,   // 96: client.BgpTransactionOperation.config:type_name -> client.BgpConfig
	8,   // 97: client.BgpTransactionOperation.neighbor:type_name -> client.BgpNeighbor
	12,  // 98: client.BgpTransactionOperation.network:type_name -> client.BgpNetwork
	13,  // 99: client.BgpTransactionOperation.route_map:type_name -> client.BgpRouteMap
	16,  // 100: client.BgpTransactionOperation.community_list:type_name -> client.BgpCommunityList
	17,  // 101: client.BgpTransactionOperation.prefix_list:type_name -> client.BgpPrefixList
	7,   // 102: client.BgpValidationRequest.config:type_name -> client.BgpConfig
	8,   // 103: client.BgpValidationRequest.neighbor:type_name -> client.BgpNeighbor
	12,  // 104: client.BgpValidationRequest.network:type_name -> client.BgpNetwork
	13,  // 105: client.BgpValidationRequest.route_map:type_name -> client.BgpRouteMap
	16,  // 106: client.BgpValidationRequest.community_list:type_name -> client.BgpCommunityList
	17,  // 107: client.BgpValidationRequest.prefix_list:type_name -> client.BgpPrefixList
	67,  // 108: client.BgpValidationResponse.errors:type_name -> client.BgpValidationError
	68,  // 109: client.BgpValidationResponse.warnings:type_name -> client.BgpValidationWarning
	89,  // 110: client.BgpValidationResponse.validation_details:type_name -> client.BgpValidationResponse.ValidationDetailsEntry
	90,  // 111: client.BgpProtocolStatus.daemon_statistics:type_name -> client.BgpProtocolStatus.DaemonStatisticsEntry
	91,  // 112: client.BgpRedistributionStatus.redistribution_metrics:type_name -> client.BgpRedistributionStatus.RedistributionMetricsEntry
	12,  // 113: client.BgpNetworkUpdate.new_network:type_name -> client.BgpNetwork
	13,  // 114: client.BgpPolicyConfig.route_maps:type_name -> client.BgpRouteMap
	16,  // 115: client.BgpPolicyConfig.community_lists:type_name -> client.BgpCommunityList
	17,  // 116: client.BgpPolicyConfig.prefix_lists:type_name -> client.BgpPrefixList
	92,  // 117: client.BgpPolicyConfig.policy_statistics:type_name -> client.BgpPolicyConfig.PolicyStatisticsEntry
	19,  // 118: client.ShowBgpSummary.InstancesEntry.value:type_name -> client.BgpSummaryInstance
	20,  // 119: client.BgpSummaryInstance.PeersEntry.value:type_name -> client.BgpPeerSummaryInfo
	22,  // 120: client.ShowBgpNeighbors.NeighborsEntry.value:type_name -> client.BgpNeighborInfo
	30,  // 121: client.ShowBgpRoutes.RoutesEntry.value:type_name -> client.BgpRouteInfo
	47,  // 122: client.ShowStaticRoutes.RoutesEntry.value:type_name -> client.StaticRouteEntry
	71,  // 123: client.BgpRedistributionStatus.RedistributionMetricsEntry.value:type_name -> client.BgpRedistributionMetrics
