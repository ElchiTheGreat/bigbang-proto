...
var file_client_client_proto_rawDesc = []byte{
	...
	0x6e, 0x64, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xef, 0x02, 0x0a, 0x07, 0x43, 0x6f,
	...
	0x42, 0x09, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0xcd, 0x02, 0x0a, 0x0f,
	...
	0x64, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x2f, 0x5a, 0x2d, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x45, 0x6c, 0x63, 0x68, 0x69, 0x54, 0x68, 0x65, 0x47, 0x72,
	0x65, 0x61, 0x74, 0x2f, 0x62, 0x69, 0x67, 0x62, 0x61, 0x6e, 0x67, 0x2d, 0x70, 0x72, 0x6f, 0x74,
...
var file_client_client_proto_goTypes = []any{
	...
	(*ResponseDeploy)(nil),          // 8: client.ResponseDeploy
	(*ResponseService)(nil),         // 9: client.ResponseService
	(*ResponseUpdateBootstrap)(nil), // 10: client.ResponseUpdateBootstrap
	(*RegisterRequest)(nil),         // 11: client.RegisterRequest
	(*UnregisterRequest)(nil),       // 12: client.UnregisterRequest
	(*RegisterResponse)(nil),        // 13: client.RegisterResponse
	(*UnregisterResponse)(nil),      // 14: client.UnregisterResponse
}
var file_client_client_proto_depIdxs = []int32{
	...
	2,  // 6: client.CommandResponse.identity:type_name -> client.Identity
	8,  // 7: client.CommandResponse.deploy:type_name -> client.ResponseDeploy
	9,  // 8: client.CommandResponse.service:type_name -> client.ResponseService
	10, // 9: client.CommandResponse.update_bootstrap:type_name -> client.ResponseUpdateBootstrap
	11, // 10: client.CommandService.Register:input_type -> client.RegisterRequest
	12, // 11: client.CommandService.Unregister:input_type -> client.UnregisterRequest
	1,  // 12: client.CommandService.CommandStream:input_type -> client.CommandResponse
	13, // 13: client.CommandService.Register:output_type -> client.RegisterResponse
	14, // 14: client.CommandService.Unregister:output_type -> client.UnregisterResponse
	0,  // 15: client.CommandService.CommandStream:output_type -> client.Command
